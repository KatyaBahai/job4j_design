...
public class Menu {
    ...
    public static final Integer SHOW_POSTS = 5;
    ...
    private static void start(CommentGenerator commentGenerator, Scanner scanner, UserGenerator userGenerator, PostStore postStore) {
        ...
        while (run) {
            ...
            if (ADD_POST == userChoice) {
                ...
                generateUsersComments(commentGenerator, userGenerator);
    ...
    private static void generateUsersComments(CommentGenerator commentGenerator,
