...
class SimpleMapTest {
    ...
    @Test
    void whenPutALargeKey() {
        assertThat(map.put(294, "10")).isTrue();
        assertThat(map).hasSize(5);
    }

    @Test
    void whenCheckRemoveNonExistingKey() {
        assertThat(map.remove(null)).isFalse();
        assertThat(map).hasSize(4);
    }
    @Test
    void whenCheckRemoveAll() {
    ...
    @Test
    void whenGetALargeKey() {
        assertThat(map.put(294, "10")).isTrue();
        assertThat(map.get(294)).isEqualTo("10");
    }

        @Test
        void whenCheckGetEverything() {
            assertThat(map.get(1)).isEqualTo("1");
